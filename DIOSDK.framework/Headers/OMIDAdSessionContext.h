 ...
 */
@interface OMIDDisplayioAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(nonnull OMIDDisplayioPartner *)partner
...
- (nullable instancetype)initWithPartner:(nonnull OMIDDisplayioPartner *)partner
                               ...
                               resources:(nonnull NSArray<OMIDDisplayioVerificationScriptResource *> *)resources
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
