...
@interface HeadlineVideoViewController ()
...
@implementation HeadlineVideoViewController
...
- (void)viewDidLoad {
    ...
    ((DIOHeadlineVideoPlacement*)placement).backgroundColorSnap = UIColor.redColor;
